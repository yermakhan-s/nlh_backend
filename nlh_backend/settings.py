"""
Django settings for nlh_backend project.
...
# SECRET_KEY = 'django-insecure-l9cd9mnd1va6&a@nh$d59b(o9l!nv@9mr*6$x262bl4m2n*6)c'
...
MIDDLEWARE = [
    ...
    'nlh_backend.utils.DisableCSRFMiddleware',
]
...
WSGI_APPLICATION = 'nlh_backend.wsgi.application'
